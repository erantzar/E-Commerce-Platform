...
export const sendVerificationEmailHTML = (verificationLink: string): string => {
  return `<!DOCTYPE html>
      <html>
        <head>
          <meta charset="UTF-8" />
...
export const sendResetPasswordEmailHTML = (resetLink: string): string => {
  return `
      <!DOCTYPE html>
      <html>
        <head>
          ...
          <style>
            * { margin: 0; padding: 0; box-sizing: border-box; }
            ...
            .header p { color: #fecaca; font-size: 15px; }
            .body { padding: 40px 32px; text-align: center; }
            .body h2 { color: #1f2937; font-size: 22px; margin-bottom: 12px; }
            .body p { color: #6b7280; font-size: 15px; line-height: 1.6; margin-bottom: 32px; }
            .btn {
              display: inline-block;
              background-color: #DC2626;
              color: #ffffff !important;
            ...
            .link-fallback { color: #6b7280; font-size: 13px; margin-bottom: 8px; }
...
export const sendTwoFactorEmailHTML = (twoFactorCode: string): string => {
  return `
      <!DOCTYPE html>
      <html>
        <head>
          ...
          <style>
            * { margin: 0; padding: 0; box-sizing: border-box; }
            ...
            .header { background-color: #1f2937; padding: 40px 20px; text-align: center; }
            .header h1 { color: #ffffff; font-size: 28px; margin-bottom: 8px; }
            ...
            .code-container p { color: #6b7280; font-size: 13px; margin-bottom: 12px; }
            .code { font-size: 48px; font-weight: bold; letter-spacing: 12px; color: #1f2937; }
            .warning {
              background-color: #fef9c3;
              border: 1px solid #fde047;
              border-radius: 8px;
        ...
        <body>
          <div class="container">
            ...
            <div class="body">
              ...
              <p>An admin login attempt was detected. Use the code below to complete your login. This code will expire in <strong>10 minutes</strong>.</p>
...
export const sendOrderEmailHTML = (order: Order): string => {
...
export const sendOrderStatusEmailHTML = (orderId: string, orderStatus: string): string => {
  ...
  const config: StatusConfig = statusConfig[orderStatus] ?? {
    emoji: "📦",
    color: "#1f2937",
    lightColor: "#f9fafb",
    borderColor: "#e5e7eb",
        ...
        <head>
          ...
          <style>
            * { margin: 0; padding: 0; box-sizing: border-box; }
            ...
            .header { background-color: ${config.color}; padding: 40px 20px; text-align: center; }
            .header h1 { color: #ffffff; font-size: 28px; margin-bottom: 8px; }
            ...
            .order-box p { color: #6b7280; font-size: 13px; margin-bottom: 8px; }
            .order-id { font-size: 20px; font-weight: bold; color: #1f2937; margin-bottom: 16px !important; }
            .status-badge {
              display: inline-block;
            ...
            .info-box p { color: ${config.textColor}; font-size: 13px; margin: 0; }
            .footer {
              background-color: #f9fafb;
              border-top: 1px solid #e5e7eb;
              padding: 24px;
