export const sendVerificationEmailHTML = (verificationLink) => {
    return `<!DOCTYPE html>
      <html>
        <head>
          <meta charset="UTF-8" />
...
export const sendResetPasswordEmailHTML = (resetLink) => {
    return `
      <!DOCTYPE html>
      <html>
        <head>
...
export const sendTwoFactorEmailHTML = (twoFactorCode) => {
    return `
      <!DOCTYPE html>
      <html>
        <head>
...
export const sendOrderEmailHTML = (order) => {
...
export const sendOrderStatusEmailHTML = (orderId, orderStatus) => {
    const statusConfig = {
        pending: {
            emoji: "🕐",
            color: "#D97706",
...
//# sourceMappingURL=mailer.messeges.js.map